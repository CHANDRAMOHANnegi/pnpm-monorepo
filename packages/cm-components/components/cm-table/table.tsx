...
export type TableColumnProp = { label: string, accessor: string, icon?: string, onClick?: (a: string) => void }[]
...
export const Table = () => {
    ...
    const { handleChangeSortKey, handleDirectionToggle } = useSort({ data: tableData, onSortChange, sortOptions: { direction: "asc", key: "id" } })
